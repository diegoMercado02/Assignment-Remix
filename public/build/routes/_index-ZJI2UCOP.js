...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701700532331.414";
}
var RoundedLinkButton = ({
  to,
  children
}) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Link, { to, className: " text-black font-semibold rounded-xl bg-purple-100 py-3 px-4 shadow-lg hover:shadow-lg focus:outline-none focus:ring focus:border-purple-300", children }, void 0, false, {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1701698449793.8547";
}
var meta = () => {
  return [{
    title: "New Remix App"
...
//# sourceMappingURL=/build/routes/_index-ZJI2UCOP.js.map
